...
class MyFirebaseMessagingService : FirebaseMessagingService() {
    ...
    private fun sendNotification(messageBody: String, messageTitle: String, imageUrl: String? = null, data: Map<String, String> = emptyMap()) {
        try {
            ...
            val defaultAppIcon = BitmapFactory.decodeResource(resources, R.drawable.app_icon)
            val brandColor = androidx.core.content.ContextCompat.getColor(this, R.color.brand_red)
            val notificationBuilder = NotificationCompat.Builder(this, channelId)
                .setSmallIcon(R.drawable.ic_notification)
                .setColor(brandColor)
                .setLargeIcon(defaultAppIcon)
